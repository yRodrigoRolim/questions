    ...
    <div class="mt-8 w-10/12 rounded-r-[16px]">
        <div class="backdrop-blur-sm p-8 rounded-r-[16px] left-animation">
            ...
            <form action="{{ route('questions.store') }}" method="POST">
                @csrf
                <input name="question" type="text" placeholder="Question" class="border-purple border-solid border-2 bg-transparent px-2 py-1 rounded w-5/12 outline-none text-white">
    ...
    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white capitalize max-w-[128px] overflow-y-auto">
                    {{ $question->question }}
                </th>
                ...
                <td class="px-6 py-4 text-center">
                    <a href="{{route('questions.edit', $question->id)}}" class="text-blue-600 hover:text-blue-800"><i class="fa-solid fa-pen-to-square"></i></a>
                </td>
                <td class="px-6 py-4 text-center">
